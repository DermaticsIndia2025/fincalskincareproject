...
const steps = [
  ...
  { id: 4, name: 'Your Product Plan', description: 'View and shop your products.' },
  { id: 5, name: 'AI Doctor\'s Report', description: 'Review your analysis summary.' },
  { id: 6, name: 'AI Assistant', description: 'Ask questions about your plan.' },
];
